					...
					<div class="w-full">
						<div class="flex mb-6">			
							<div class="w-1/2 mr-2">
								...
								<input name="name" class="shadow border rounded w-full px-3 py-2 {{ $errors->has('name') ? 'border-red' : '' }}" />
							</div>
							<div class="w-1/2 ml-2">
								...
								<input name="property_number" class="shadow border rounded w-full px-3 py-2 {{ $errors->has('property_number') ? 'border-red' : '' }}" />
							</div>						
						</div>
						<div class="flex mb-6">			
							<div class="w-1/2 mr-2">
